...
public class Getdata extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
	      ...
	      //  String query = "for $x in doc(\"/db/test/hihi/BOOKSTORE\")//author return $x";
	        ...
	        if(EcuName.equals("LockgCen") || EcuName.equals("IntrLi")|| 
	 			   EcuName.equals("MirrAdjmt") || EcuName.equals("MirrTintg")||	
	 			   EcuName.equals("SeatAdjmt") || EcuName.equals("WiprWshr")||
	 			   EcuName.equals("EntryRemKeyls") || EcuName.equals("KeyPad")||
	 			   EcuName.equals("Antithft") || EcuName.equals("ExtrLi")||
	 			   EcuName.equals("TerminalClmpCtrl") || EcuName.equals("HornCtrl")||
	 			   EcuName.equals("RoofCnvtbCtrl") || EcuName.equals("DefrstCtrl")||
	 			   EcuName.equals("Imob") || EcuName.equals("Pase")||
	 			   EcuName.equals("SnsrBody") || EcuName.equals("SeatClima"))
	 				PartName = new String("Body");
	 			/*Body_Part_Select_End*/
	 			
	 			/*PT_Part_Select_Start*/
	 			if(EcuName.equals("PtCoorr") || EcuName.equals("Trsm")|| 
	 			   EcuName.equals("CmbEng") || EcuName.equals("VehMtnForPt")||	
	 			   EcuName.equals("PtMisc"))
	 				PartName = new String("PT");
	 			/*PT_Part_Select_End*/
	 			
	 			/*Chassis_Part_Select_Start*/
	 			if(EcuName.equals("CrsCtrlAndAcc") || EcuName.equals("Esc")|| 
	 			   EcuName.equals("Ssm") || EcuName.equals("Epb")||	
	 			   EcuName.equals("Vlc") || EcuName.equals("Rsc")||
	 			   EcuName.equals("Steer") || EcuName.equals("SteerVehStabyCtrl")||
	 			   EcuName.equals("SteerDrvrAsscSys") || EcuName.equals("Susp")||
	 			   EcuName.equals("DtTqDistbn") || EcuName.equals("TirePMon")||
	 			   EcuName.equals("ChassisSnsr") || EcuName.equals("SurrndgsSnsr"))
	...
	+"\n let $log-in := xmldb:login(\"/db\", \"admin\", \"jh1105\")"
	...
	+"\n let $ALL_copy :=doc(\"/db/AUTOSAR/"+PartName+"/TEST_"+EcuName+".arxml\")/AUTOSAR/AR-PACKAGES/AR-PACKAGE/AR-PACKAGES/AR-PACKAGE/AR-PACKAGES/AR-PACKAGE"
	...
	//+"\n let $ECU := for $ECU in $SW[SHORT-NAME = \"Imob\"] return $ECU"
	...
	+"\n return doc(\"/db/AUTOSAR/"+PartName+"/TEST_"+EcuName+".arxml\")";
	         ...
	         String query = 
	                 ...
	                 + "\n let $APD := $ALL/APPLICATION-PRIMITIVE-DATA-TYPE"
	                 + "\n let $DATATYPE := ($APD,$ARD,$AAD)"
	                 + "\n let $ECU_Main := for $ECU_Main in $SWC[SHORT-NAME =\""+Ecuname+"\"] return $ECU_Main"
